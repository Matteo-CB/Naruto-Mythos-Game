...
export const QUETES_SHINOBI_SHIREN: QueteAnnoncee[] = [
  ...
  },
  {
    ...
    text_pt: 'copie 5 efeitos com um Kakashi do set 2',
    text_it: 'copia 5 effetti con un Kakashi del set 2',
    text_pl: 'skopiuj 5 efektów kartą Kakashiego z zestawu 2',
    text_ja: 'セット2のはたけカカシで効果を5つコピーする',
  },
  {
