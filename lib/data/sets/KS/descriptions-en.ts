...
export const effectDescriptionsEn: Record<string, string[]> = {
  ...
  'KS-033-UC': [
    '[⧗] If there is an enemy Jutsu character in this mission, you can play this character while hidden paying 4 less.',
    '[↯] Move this character.',
  ],
  ...
  'KS-102-UC': [
    '[↯] Defeat an enemy Summon character in this mission.',
    '[⧗] At the end of the round, you must return this character to your hand.',
  ],
