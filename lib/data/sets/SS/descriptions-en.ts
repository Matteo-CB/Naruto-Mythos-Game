export const effectDescriptionsEn: Record<string, string[]> = {
  ...
  "SS-134-R": [
    "[↯] Itachi Uchiha: Defeat the strongest enemy character in this mission if they have at least 6 Power.",
    "DUEL effect: Instead, defeat them if they have at least 5 Power.",
  ],
  "SS-126-SPV": [
  ...
  "SS-120-CHIBIV": [
    "[⧗] The opponent must pay 1 more Chakra when revealing characters from hidden in this mission.",
    "[↯] Naruto Uzumaki: Hide an enemy character with Power 4 or less in play.",
  ],
  "SS-147-POPV": [
