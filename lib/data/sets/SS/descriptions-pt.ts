export const effectDescriptionsPt: Record<string, string[]> = {
  ...
  "SS-122-SPV": [
    "[↯] Descarte todos os personagens de Fera com Cauda de uma pilha inimiga nesta missão ou mova um personagem de Fera com Cauda aliado em jogo.",
  ],
  "SS-121-R": [
  ...
  "SS-134-R": [
    "[↯] Itachi Uchiha: Derrote o personagem inimigo mais forte nesta missão se ele tiver pelo menos 6 de Poder.",
    "efeito DUEL: Em vez disso, derrote-o se ele tiver pelo menos 5 de Poder.",
  ],
  "SS-126-SPV": [
  ...
  "SS-120-CHIBIV": [
    "[⧗] O adversário deve pagar 1 Chakra a mais ao revelar personagens ocultos nesta missão.",
    "[↯] Naruto Uzumaki: Oculte um personagem inimigo com Poder 4 ou menos em jogo.",
  ],
  "SS-147-POPV": [
  ...
  "SS-128-R": [
    "[⧗] Dobre o Poder dos acessórios de Comida neste personagem.",
    "[↯] Jirobo: Derrote um personagem inimigo nesta missão com Poder 8 ou mais.",
  ],
  "SS-082-C": [
    "Anexe a um personagem aliado não-oculto.",
    "[↯] Se este personagem não tiver fichas de Poder, POWERUP 3.",
  ],
  "SS-108-C": [
    "Anexe a uma missão.",
