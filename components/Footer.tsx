    ...
    >
      ...
      <div className="flex items-center gap-3">
        ...
        <SocialLink href={DISCORD_URL} label="Discord">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="#c4a35a">
        ...
        <SocialLink href={TIKTOK_URL} label="TikTok">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="#c4a35a">
            <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-2.88 2.5 2.89 2.89 0 0 1-2.89-2.89 2.89 2.89 0 0 1 2.89-2.89c.28 0 .54.04.79.1v-3.5a6.37 6.37 0 0 0-.79-.05A6.34 6.34 0 0 0 3.15 15a6.34 6.34 0 0 0 6.34 6.34 6.34 6.34 0 0 0 6.34-6.34V8.75a8.23 8.23 0 0 0 4.81 1.54V6.84a4.84 4.84 0 0 1-1.05-.15z"/>
          </svg>
        </SocialLink>
      </div>
