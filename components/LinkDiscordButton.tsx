...
export function LinkDiscordButton() {
  ...
  return (
    <motion.a
      ...
      style={{ color: DISCORD, backgroundColor: 'rgba(88, 101, 242, 0.12)' }}
      animate={
        animationsEnabled
          ? {
              scale: [1, 1.07, 1],
              boxShadow: [
                '0 0 0px rgba(88, 101, 242, 0)',
                '0 0 14px rgba(88, 101, 242, 0.55)',
                '0 0 0px rgba(88, 101, 242, 0)',
              ],
            }
          : { scale: 1.05, boxShadow: '0 0 12px rgba(88, 101, 242, 0.4)' }
      }
      transition={
        animationsEnabled
