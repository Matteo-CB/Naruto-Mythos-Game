      ...
      {open && (
        <>
          ...
          >
            ...
            >
              <div>
                <h2 className="text-[13px] uppercase tracking-[0.18em] text-[var(--t-accent)]">{t('panelTitle')}</h2>
              ...
              <button
                ...
                data-gp="true"
                className="px-3 py-2 text-[16px] text-[var(--t-muted)] hover:text-[var(--t-text)]"
              >
                X
              </button>
            </header>
            ...
            <div className="flex-1 overflow-y-auto px-4 py-4">
              {matches.length === 0 && (
                <p className="px-1 py-6 text-center text-[12px] text-[var(--t-muted)]">{t('noLiveMatches')}</p>
              )}
                  ...
                  return (
                    <li key={match.roomCode}>
                      <button
                        ...
                        style={{
                          backgroundColor: isSelected ? 'var(--t-accent-glow)' : 'rgba(255,255,255,0.02)',
                      ...
                      >
                        ...
                        <span className="mt-1 block text-[11px] text-[var(--t-muted)]">
