...
export const MOBILE_FIXED_DIMS: GameDimensions = {
  ...
  isMobile: true,
  handCard: { w: 92, h: 129 },
  missionCard: { w: 60, h: 82 },
  sideCard: { w: 46, h: 64 },
  opponentCard: { w: 36, h: 50 },
  targetCard: { w: 64, h: 90 },
  mulliganCard: { w: 88, h: 123 },
  handSelectorCard: { w: 84, h: 118 },
  previewMed: { w: 100, h: 140 },
  previewLg: { w: 130, h: 182 },
  animHand: { w: 92, h: 129 },
  animBoard: { w: 72, h: 101 },
  animDeck: { w: 34, h: 48 },
  handFanSpacing: 56,
  handFanArc: 2,
  handContainerH: 122,
  ...
  playerHandH: 118,
  opponentHandH: 42,
  opponentFanSpacing: 13,
  opponentContainerH: 40,
  opponentMinW: 190,
  sidePileW: 60,
  missionMaxW: 92,
  emptyLaneMinW: 190,
